...
<%@include file="Header.jsp" %>
	...
	<form action="LoginCtl" method="post">
		<table align="center" width="100%" >
			<tr>
				<td style="text-align: right; width: 40%">Login ID</td>
				<td style="text-align: left;"><input type="email" name="login"
					id="login"></td>
			...
			<tr>
				<td></td>
				<td width="50%"><a href="UserRegistrationView.jsp">Signup </a>||<a
